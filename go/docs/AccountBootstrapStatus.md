...
`func NewAccountBootstrapStatus(id string, status string, capabilities []string, expiresAt time.Time, approval AccountBootstrapApproval, ) *AccountBootstrapStatus`
