...
func main() {
	accountBootstrapRequest := *openapiclient.NewAccountBootstrapRequest("Email_example", "AgentName_example", "OauthClientId_example", []string{"RequestedScopes_example"}) // AccountBootstrapRequest |
