...
**OauthClientId** | **string** | Existing dynamically registered or seeded OAuth client ID. |
...
`func NewAccountBootstrapRequest(email string, agentName string, oauthClientId string, requestedScopes []string, ) *AccountBootstrapRequest`
