...
**DeviceCode** | Pointer to **string** | Transitional response field for older CLI releases that use OAuth device exchange. | [optional]
...
`func (o *AccountBootstrapCreated) SetExpiresAtNil(b bool)`

 SetExpiresAtNil sets the value for ExpiresAt to be an explicit nil

### UnsetExpiresAt
`func (o *AccountBootstrapCreated) UnsetExpiresAt()`
