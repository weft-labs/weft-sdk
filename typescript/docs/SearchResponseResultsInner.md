...
```typescript
import type { SearchResponseResultsInner } from '@weft-labs/sdk'
...
const example = {
  ...
  "ranking": null,
  "endpoints": null,
} satisfies SearchResponseResultsInner
...
const exampleParsed = JSON.parse(exampleJSON) as SearchResponseResultsInner
