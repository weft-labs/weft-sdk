...
module Weft
  class AccountBootstrapRequest < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if @requested_scopes.nil?
        invalid_properties.push('invalid value for "requested_scopes", requested_scopes cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @requested_scopes.nil?
      true
    end
