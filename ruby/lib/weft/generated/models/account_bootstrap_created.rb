...
module Weft
  class AccountBootstrapCreated < ApiModelBase
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["pending", "claimed", "rejected", "expired", "consumed"])
      ...
      return false if @device_code.to_s.length < 32
      true
    end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["pending", "claimed", "rejected", "expired", "consumed"])
