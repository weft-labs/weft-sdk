...
api_instance = Weft::AgentBootstrapApi.new
account_bootstrap_request = Weft::AccountBootstrapRequest.new({email: 'email_example', agent_name: 'agent_name_example', oauth_client_id: 'oauth_client_id_example', requested_scopes: ['balance']}) # AccountBootstrapRequest |
