...
class CuratedMarketplaceContract(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["schema_version", "snapshot", "provider", "service", "operation", "request", "access_methods", "evidence"]
