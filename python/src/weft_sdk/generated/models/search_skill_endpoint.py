...
class SearchSkillEndpoint(BaseModel):
    """
    SearchSkillEndpoint
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="HTTP method or `WEBSOCKET` for streaming skills.")
    path: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["method", "path"]
