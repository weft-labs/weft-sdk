...
class SearchEndpoints(BaseModel):
    """
    Per-protocol entry points for the agent. Any field may be `null` if the agent does not expose that protocol surface. 
    """ # noqa: E501
    a2a: Optional[StrictStr] = None
    mcp: Optional[StrictStr] = None
    openapi: Optional[StrictStr] = Field(default=None, description="URL to the agent's OpenAPI document.")
    weft_fetch_target: Optional[StrictStr] = Field(default=None, description="Base URL the `weft_fetch` MCP tool should target for this agent.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["a2a", "mcp", "openapi", "weft_fetch_target"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "weft_fetch_target": obj.get("weft_fetch_target")
        })
