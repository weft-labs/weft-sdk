...
**expires_at** | **datetime** | Claim-window expiry. Null after the credential is promoted. |
...
**device_code** | **str** | Transitional response field for older CLI releases that use OAuth device exchange. | [optional]
